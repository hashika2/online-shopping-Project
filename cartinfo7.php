...
if(isset($_POST["add_to_cart"])){
    if(isset($_SESSION["shopping_cart"])){
        ...
        else
        {
            ...
            echo '<script>window.location="cartinfo7.php"</script>';
            ...
            <div class="table">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td><a href="cartinfo7.php?action=delete&id=<?php echo $values["item_id"];?>"><span class="re">Remove</span></a></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" aling="right"><b><a href="menspec.php">Add</a></b></td>
