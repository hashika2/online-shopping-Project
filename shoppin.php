...
<html>
    ...
    <body>
        ...
        <div id="hd">
          <div id="subhd">
            <div class="container">
              <p>Sri Lankan fastest online shopiinng service   <a href="#">partner</a>
              <a href="#">partne</a>
              <a href="#">partne</a></p>
</div>
        ...
        <div class="slideshow-container">
          ...
          <div class="mySlides fade">
            ...
            <img src="offer5.jpg"height="400px" style="width:100%">
            <div class="text"></div>
          </div>
      ...
      <ul class="sub_head" style="background-color:rgb(104, 100, 100); padding: 1px;margin: 20px;" >
       ...
       <!---catagory-->
          <div class="container">
            ...
            <a href="popular.html">
                <div class="catbox">
                    <img src="shirts/sh5.jpg " height="400px" alt="bag">
                    <span>Shirts <b>10%</b></span>
