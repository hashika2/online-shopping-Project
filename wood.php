    ...
    if($_GET["action"] == "delete")
    {
        foreach($_SESSION["shopping_cart"] as $keys => $values)
        {
            if($values["item_id"] == $_GET["id"])
            {
                ...
                echo '<script>window.location="wood.php"</script>';
            }
        }
    }
}
...
<html>
    ...
    <ul style="background-color: rgb(82, 4, 4);">
        ...
        <div class="ca1">
            ...
            <div class="ca2">
            <form method="post" action="wood.php?action=add&id=<?php echo $row["id"]; ?>">
                <div class="ca3" style="margin-left:50px;width:250px;height:500px" >
                    <img src="chair/<?php echo $row["image"]; ?>" style="width:200px; height:250px;" >
            ...
            <div class="table">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td><a href="wood.php?action=delete&id=<?php echo $values["item_id"];?>"><span class="re">Remove</span></a></td>
