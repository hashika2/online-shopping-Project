...
<html>
    ...
    <ul style="background-color: rgb(82, 4, 4);">
                    ...
                    <img src="images/Capture.PNG " height="60px" width="250px">
                      ...
                      <input class="input" type="text"placeholder ="search.."style="  border-radius:10px;width:800px;width:500px" ><button type="submit"style="  border-radius:10px;">search</button>
                    </ul>
...
if(isset($_POST["add_to_cart"])){
    if(isset($_SESSION["shopping_cart"])){
        ...
        else
        {
            ...
            echo '<script>window.location="cartinfo1.php"</script>';
            ...
            <div class="table">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td><a href="cartinfo1.php?action=delete&id=<?php echo $values["item_id"];?>"><span class="re">Remove</span></a></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" aling="right"><b><a href="popular.php">Add</a></b></td>
                    </tr>
                    <?php
                    }
