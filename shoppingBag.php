...
<html>
    ...
    <body>
            <ul style="background-color: rgb(82, 4, 4);">
                ...
                <!--products-->
                <?php
             $query = "SELECT * FROM cart WHERE id >24 and id <=36";
            ...
            if(mysqli_num_rows($result)>0){
                while($row = mysqli_fetch_array($result))
                {
                    ?>
                    <div class="ca2">
                    <form method="post" action="shoppingBag.php?action=add&id=<?php echo $row["id"]; ?>">
                    <div class="prod-container">
                                <!--first product-->
                            <div class="prod-box" >
                                    <img src="bags/<?php echo $row["image"]; ?>" height="300px" alt="man suit">
